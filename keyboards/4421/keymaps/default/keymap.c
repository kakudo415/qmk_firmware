...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_NO,   KC_LALT, KC_LGUI, KC_NO, KC_SPC, MO(_FN), MO(_FN), KC_SPC, KC_NO,   KC_RGUI, KC_RALT, KC_NO 
    ),
    [_FN] = LAYOUT(
        ...
        KC_NO,   KC_LALT, KC_LGUI, KC_NO, RESET,  KC_NO, KC_NO, RESET, KC_NO, KC_RGUI, KC_RALT, KC_NO
    )
};
